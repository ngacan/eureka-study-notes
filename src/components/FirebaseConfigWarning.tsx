    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-slate-900 text-white p-4">
      <div className="text-center p-8 bg-slate-800 rounded-lg shadow-2xl max-w-3xl w-full border border-red-500/50">
        ...
        <div className="mt-6 text-left bg-slate-900 p-4 rounded-md text-sm text-slate-400 space-y-2">
           <p><strong>Bước chính:</strong> Mở tệp <code className="bg-slate-700 px-1.5 py-0.5 rounded text-sky-400">src/firebaseConfig.ts</code> trong dự án, làm theo hướng dẫn trong đó và dán các giá trị bạn nhận được từ Firebase và Google Cloud vào.</p>
        </div>
            ...
            <div className="mt-4 text-left bg-slate-800/50 p-4 rounded-md text-sm text-slate-400 space-y-3 animate-fade-in">
                ...
                <ol className="list-decimal list-inside space-y-2">
                    ...
                    <li>
                        ...
                        <div className="mt-1 pl-4">
                            <p className="text-xs text-slate-500">Sao chép các giá trị như <code className="text-pink-400">apiKey</code>, <code className="text-pink-400">authDomain</code>, v.v. và dán chúng vào tệp <code className="text-sky-400">src/firebaseConfig.ts</code>.</p>
                        </div>
                    </li>
                     <li>
                        ...
                        <ul className="list-disc list-inside ml-4 mt-1 text-slate-500">
                            ...
                            <li>Sao chép giá trị <strong>Client ID</strong> và dán vào trường `googleClientId` trong tệp <code className="text-sky-400">src/firebaseConfig.ts</code>.</li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>Lưu tệp <code className="text-sky-400">src/firebaseConfig.ts</code> và tải lại trang này.</li>
                </ol>
